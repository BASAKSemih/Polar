 ...
 */
final class Version20211116203256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission ADD country_id INT NOT NULL, DROP country');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission ADD country VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP country_id');
    }
}
