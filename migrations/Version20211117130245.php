 ...
 */
final class Version20211117130245 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission ADD speciality_id INT NOT NULL, DROP speciality');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission ADD speciality VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP speciality_id');
    }
}
